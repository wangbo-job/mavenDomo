...
public class AliyunOSSClientUtils {
	...
	// accessKey
	private String accessKeyId = "LTAI4Fm5tfdvZjunhFvVBc9b";
	private String accessKeySecret = "91LKsDQDPaytmgZ6kLcqfNuLJeCNEk";
	// 空间
	private String bucketName = "xiaobb";
	// 文件存储目录
